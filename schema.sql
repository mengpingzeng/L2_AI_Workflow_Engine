...
CREATE TABLE IF NOT EXISTS workflow_task (
    ...
    novel_name       VARCHAR(256) DEFAULT ''            COMMENT '小说名称',
    title            VARCHAR(256) DEFAULT ''            COMMENT '章节标题',
    volume_name      VARCHAR(256) DEFAULT ''            COMMENT '分卷名称',
    chapter_number   INT DEFAULT 0                      COMMENT '章节序号',
    ...
    status           ENUM('init','fetch_draft','publishing','published',
                          ...
                          'failed_gen','failed_md','published_failed') NOT NULL DEFAULT 'init'
                                                        COMMENT '任务状态',
    session_id       VARCHAR(64) NOT NULL                COMMENT 'Agent Session ID',
    draft_version    INT DEFAULT 0                      COMMENT '草稿版本号',
    draft_hash       VARCHAR(128) DEFAULT ''            COMMENT '草稿内容 SHA256 指纹',
